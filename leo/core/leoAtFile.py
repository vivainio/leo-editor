#@+leo-ver=cub-1-thin
#@0 [ekr.20150323150718.1] @f leoAtFile.py
...
class AtFile:
    ...
    #@< at.Reading
    #@> at.Reading (top level)
    #@> at.checkExternalFile
    ...
    #@< at.scanHeaderForThin (import code)
    ...
    #@ at.writeOneAtShadowNode & helper
    ...
    #@ at.putSentinel (applies cweb hack) 4.x
    ...
    #@< at.outputStringWithLineEndings
    ...
    #@ at.precheck (calls shouldPrompt...)
    ...
    #@ at.warnAboutOrpanAndIgnoredNodes
    # Called from putFile.
