#@+leo-ver=cub-1-thin
#@0 [ekr.20171124073126.1] @f ../commands/commanderHelpCommands.py
...
#@+others
#@ c_help.about (version number & date)
...
#@ c_help.Open Leo files
#@> c_help.leoDocumentation
...
#@ c_help.openMyLeoSettings & helper
...
#@> function: c_help.createMyLeoSettings
...
#@ c_help.openLeoScriptingMiscellany
