#@+leo-ver=cub-1-thin
#@0 [ekr.20171123135539.1] @f ../commands/commanderEditCommands.py
...
#@ c_ec.dedentBody (unindent-region)
...
#@< c_ec.editHeadline (edit-headline)
...
#@ c_ec.alwaysIndentBody (always-indent-region)
...
#@ c_ec.reformatParagraph & helpers
...
#@> function: ends_paragraph & single_line_paragraph
...
def rp_wrap_all_lines(
    ...
    result_list = g.wrap_lines(lines, pageWidth - indents[1], pageWidth - indents[0])
...
#@ c_ec.show/hide/toggleInvisibles
...
#@< c_ec: insert-jupyter-toc & insert-markdown-toc
