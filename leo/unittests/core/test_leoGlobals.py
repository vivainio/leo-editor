#@+leo-ver=cub-1-thin
#@0 [ekr.20210902164946.1] @f ../unittests/core/test_leoGlobals.py
...
class TestGlobals(LeoUnitTest):
    ...
    #@+others
    #@<  TestGlobals: setup helpers and related tests
    #@> TestGlobals._define_per_commander_data
    ...
    #@ TestGlobals._test_per_commander_data
    ...
    #@ TestGlobals._patch_at_data_unl_path_prefixes
    ...
    #@ TestGlobals.test_per_commander_data
    ...
    #@< --- legacy tests
    #@> TestGlobals.test_g_checkVersion
    ...
    #@ TestGlobals.test_g_CheckVersionToInt
    ...
    #@ TestGlobals.test_g_comment_delims_from_extension
    ...
    #@ TestGlobals.test_g_convertPythonIndexToRowCol
    ...
    #@ TestGlobals.test_g_convertRowColToPythonIndex
    ...
    #@ TestGlobals.test_g_create_temp_file
    ...
    #@ TestGlobals.test_g_ensureLeadingNewlines
    ...
    #@ TestGlobals.test_g_ensureTrailingNewlines
    ...
    #@ TestGlobals.test_g_getDocString
    ...
    #@ TestGlobals.test_g_getWord
    def test_g_getWord(self):
        s = 'abc xy_z5 pdq'
        i, j = g.getWord(s, 5)
        self.assertEqual(s[i:j], 'xy_z5')

    #@ TestGlobals.test_g_guessExternalEditor
    ...
    #@ TestGlobals.test_g_handleScriptException
    ...
    #@ TestGlobals.test_g_objToString
    ...
    #@< TestGlobals.test_g_OptionsUtils
    ...
    #@ TestGlobals.test_g_os_path_finalize_join_with_thumb_drive
    ...
    #@ TestGlobals.test_g_relativeDirectory
    ...
    #@ TestGlobals.test_g_removeBlankLines
    ...
    #@ TestGlobals.test_g_removeLeadingBlankLines
    ...
    #@ TestGlobals.test_g_removeTrailing
    ...
    #@ TestGlobals.test_g_sanitize_filename
    ...
    #@ TestGlobals.test_g_set_delims_from_language
    ...
    #@ TestGlobals.test_g_set_delims_from_string
    ...
    #@ TestGlobals.test_g_skip_blank_lines
    ...
    #@ TestGlobals.test_g_skip_to_end_of_line
    ...
    #@ TestGlobals.test_g_skip_to_start_of_line
    ...
    #@ TestGlobals.test_g_splitLinesAtNewline
    ...
    #@ TestGlobals.test_g_splitLongFileName
    ...
    #@ TestGlobals.test_g_stripPathCruft
    ...
    #@ TestGlobals.test_g_warnOnReadOnlyFile
    ...
    #@ TestGlobals.test_getLastTracebackFileAndLineNumber
    ...
    #@ TestGlobals.test_g_findUnl (legacy)
    ...
    #@ TestGlobals.test_g_getUNLFilePart
    ...
    #@ TestGlobals.test_p_get_star_UNL
    ...
    #@ TestGlobals.test_g_openUNLFile
    ...
    #@ TestGlobals.test_g_parsePathData
