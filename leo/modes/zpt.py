...
def zpt_rule4(colorer, s, i):
    return colorer.match_span(s, i, kind="markup", begin="<", end=">", delegate="zpt::tags")
...
def zpt_rule18(colorer, s, i):
    return colorer.match_seq(s, i, kind="markup", seq=">", delegate="javascript::main")


def zpt_rule19(colorer, s, i):
    return colorer.match_seq(s, i, kind="markup", seq="SRC=", delegate="zpt::back_to_html")
...
def zpt_rule20(colorer, s, i):
    return colorer.match_seq(s, i, kind="markup", seq=">", delegate="zpt::main")
...
def zpt_rule21(colorer, s, i):
    return colorer.match_seq(s, i, kind="markup", seq=">", delegate="css::main")
