...
def asciidoc_rule0(colorer, s, i):
    return colorer.match_eol_span(s, i, kind="markup", seq="=====", at_line_start=True)
...
def asciidoc_rule18(colorer, s, i):
    return colorer.match_span(s, i, kind="label", begin="[[", end="]]", at_line_start=True)
...
def asciidoc_rule20(colorer, s, i):
    return colorer.match_span(s, i, kind="markup", begin="[", end="]", at_line_start=True)
...
def asciidoc_rule27(colorer, s, i):
    return colorer.match_seq(s, i, kind="markup", seq="-", at_line_start=True)
...
def asciidoc_rule41(colorer, s, i):
    return colorer.match_eol_span_regexp(s, i, kind="label", regexp="^\\.\\S", at_line_start=True)
...
def asciidoc_rule43(colorer, s, i):
    return colorer.match_eol_span(s, i, kind="operator", seq="|==", at_line_start=True)
...
def asciidoc_rule45(colorer, s, i):
    return colorer.match_span(s, i, kind="markup", begin="NOTE:", end=" ", at_line_start=True)
