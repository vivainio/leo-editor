#@+leo-ver=cub-1-thin
#@0 [ekr.20230419050031.1] @f ../modes/html.py
"""
...
#@ html_rule_script <script..</script>
...
#@ html_rule_at_language @language
...
#@ html_rule_end_template </template>
...
#@ << html.py: dictionaries >>
#@+others
#@> html.py: Properties dict
# Properties for html mode.
properties = {
    "commentEnd": "-->",
    "commentStart": "<!--",
}
#@ html.py: Attributes dicts
