...
def lilypond_rule8(colorer, s, i):
    return colorer.match_mark_previous(s, i, kind="function", pattern="=", at_whitespace_end=True)
...
def lilypond_rule10(colorer, s, i):
    return colorer.match_span(s, i, kind="literal2", begin="#(", end=")", delegate="scheme::main")
