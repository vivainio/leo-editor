...
def pop11_rule5(colorer, s, i):
    return colorer.match_span(s, i, kind="literal1", begin="[", end="]", delegate="pop11::list")
...
def pop11_rule12(colorer, s, i):
    return colorer.match_mark_following(s, i, kind="label", pattern="#_", at_line_start=True)
...
def pop11_rule38(colorer, s, i):
    return colorer.match_span(s, i, kind="null", begin="%", end="%", delegate="pop11::main")
