...
def scala_rule5(colorer, s, i):
    return colorer.match_seq_regexp(
        s, i, kind="comment2", regexp="<!--", at_whitespace_end=True, delegate="scala::xml_comment"
    )


def scala_rule6(colorer, s, i):
    return colorer.match_seq_regexp(
        s, i, kind="literal3", regexp="<\\/?\\w*", at_whitespace_end=True, delegate="scala::xml_tag"
    )
...
def scala_rule58(colorer, s, i):
    return colorer.match_span(s, i, kind="", begin="{", end="}", delegate="scala::main")


def scala_rule59(colorer, s, i):
    return colorer.match_seq_regexp(s, i, kind="literal3", regexp=">$", delegate="scala::main")
...
def scala_rule62(colorer, s, i):
    return colorer.match_seq(s, i, kind="literal3", seq=">", delegate="scala::xml_text")
...
def scala_rule66(colorer, s, i):
    return colorer.match_seq_regexp(s, i, kind="comment2", regexp="-->$", delegate="scala::main")
...
def scala_rule68(colorer, s, i):
    return colorer.match_seq(s, i, kind="comment2", seq="-->", delegate="scala::xml_text")
