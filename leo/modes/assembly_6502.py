...
def assembly_6502_rule5(colorer, s, i):
    return colorer.match_mark_following(s, i, kind="digit", pattern="$", exclude_match=True)
...
rulesDict1 = {
    ...
    "!": [
        assembly_6502_rule16,
        assembly_6502_rule24,
    ],
    "\"": [
        assembly_6502_rule2,
    ],
    ...
    "&": [
        assembly_6502_rule14,
        assembly_6502_rule27,
    ],
    "'": [
        assembly_6502_rule1,
    ],
    ...
    "<": [
        assembly_6502_rule18,
        assembly_6502_rule20,
        assembly_6502_rule22,
        assembly_6502_rule25,
    ],
    "=": [
        assembly_6502_rule17,
        assembly_6502_rule23,
    ],
    ">": [
        assembly_6502_rule19,
        assembly_6502_rule21,
        assembly_6502_rule26,
    ],
    "@": [
        assembly_6502_rule29,
    ],
    ...
    "|": [
        assembly_6502_rule12,
        assembly_6502_rule28,
    ],
    "~": [
