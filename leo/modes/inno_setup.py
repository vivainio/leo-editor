...
def inno_setup_rule1(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[Setup]", at_line_start=True)


def inno_setup_rule2(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[Types]", at_line_start=True)


def inno_setup_rule3(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[Components]", at_line_start=True)


def inno_setup_rule4(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[Tasks]", at_line_start=True)


def inno_setup_rule5(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[Dirs]", at_line_start=True)


def inno_setup_rule6(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[Files]", at_line_start=True)


def inno_setup_rule7(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[Icons]", at_line_start=True)


def inno_setup_rule8(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[INI]", at_line_start=True)


def inno_setup_rule9(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[InstallDelete]", at_line_start=True)


def inno_setup_rule10(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[Languages]", at_line_start=True)


def inno_setup_rule11(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[Messages]", at_line_start=True)


def inno_setup_rule12(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[CustomMessages]", at_line_start=True)


def inno_setup_rule13(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[LangOptions]", at_line_start=True)


def inno_setup_rule14(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[Registry]", at_line_start=True)


def inno_setup_rule15(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[Run]", at_line_start=True)


def inno_setup_rule16(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[UninstallRun]", at_line_start=True)


def inno_setup_rule17(colorer, s, i):
    return colorer.match_seq(s, i, kind="keyword2", seq="[UninstallDelete]", at_line_start=True)
...
def inno_setup_rule48(colorer, s, i):
    return colorer.match_mark_following(s, i, kind="function", pattern="code:", exclude_match=True)
