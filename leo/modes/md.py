#@+leo-ver=cub-1-thin
#@0 [ekr.20241030152835.1] @f ../modes/md.py
#@@language python
"""
...
def md_rule5(colorer, s, i):
    return colorer.match_span(s, i, kind="markup", begin="<", end=">", delegate="md::inline_markup")
...
def md_rule37(colorer, s, i):
    return colorer.match_eol_span(s, i, kind="null", seq=")", delegate="md::main")
...
def md_rule52(colorer, s, i):
    # leadin: [
    return colorer.match_eol_span_regexp(
        s, i, kind="label", regexp="\\[(.*?)\\]\\:", delegate="md::link_label_definition"
    )
