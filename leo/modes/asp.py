...
def asp_rule4(colorer, s, i):
    return colorer.match_span(s, i, kind="markup", begin="<%", end="%>", delegate="vbscript::main")
...
def asp_rule5(colorer, s, i):
    return colorer.match_span(
        ...
        i,
        kind="markup",
        begin="<script language=\"vbscript\" runat=\"server\">",
        end="</script>",
...
def asp_rule6(colorer, s, i):
    return colorer.match_span(
        ...
        i,
        kind="markup",
        begin="<script language=\"jscript\" runat=\"server\">",
        end="</script>",
...
def asp_rule7(colorer, s, i):
    return colorer.match_span(
        ...
        i,
        kind="markup",
        begin="<script language=\"javascript\" runat=\"server\">",
        end="</script>",
        delegate="javascript::main",
    )
...
def asp_rule8(colorer, s, i):
    return colorer.match_span(
        ...
        i,
        kind="markup",
        begin="<script language=\"perlscript\" runat=\"server\">",
        end="</script>",
        delegate="perl::main",
    )
...
def asp_rule15(colorer, s, i):
    return colorer.match_span(s, i, kind="markup", begin="<", end=">", delegate="asp::aspvb_tags")
...
def asp_rule42(colorer, s, i):
    return colorer.match_span(s, i, kind="markup", begin="</", end=">", delegate="asp::aspjs_tags")
...
def asp_rule45(colorer, s, i):
    return colorer.match_span(s, i, kind="markup", begin="<%", end="%>", delegate="perl::main")
...
def asp_rule56(colorer, s, i):
    return colorer.match_span(s, i, kind="markup", begin="</", end=">", delegate="asp::asppl_tags")
