...
def rpmspec_rule4(colorer, s, i):
    return colorer.match_span(
        s, i, kind="markup", begin="%attr(", end=")", delegate="rpmspec::attr", no_line_break=True
    )
...
def rpmspec_rule6(colorer, s, i):
    return colorer.match_mark_following(s, i, kind="keyword1", pattern="Source", at_line_start=True)


def rpmspec_rule7(colorer, s, i):
    return colorer.match_mark_following(s, i, kind="keyword1", pattern="Patch", at_line_start=True)


def rpmspec_rule8(colorer, s, i):
    return colorer.match_mark_following(s, i, kind="function", pattern="%patch", at_line_start=True)
