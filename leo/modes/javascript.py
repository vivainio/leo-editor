#@+leo-ver=cub-1-thin
#@0 [ekr.20230419052236.1] @f ../modes/javascript.py
"""
...
#@ javascript_rule_end_script </script>
...
#@ javascript_rule_at_language @language
...
#@<2 << javascript.py: dictionaries >>
#@+others
#@> javascript.py: properties dict
...
#@ javascript.py: attributes dicts
...
#@ javascript.py: Rules dict for javascript_main ruleset
