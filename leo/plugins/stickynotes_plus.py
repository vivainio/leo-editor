#@+leo-ver=cub-1-thin
#@0 [ekr.20100103093121.5339] @f ../plugins/stickynotes_plus.py
#@+<< docstring >>
#@> << docstring >>
...
class notetextedit(QTextEdit):
    ...
    #@ keyPressEvent__ (stickynotes_plus.py)
    ...
    #@ mouseMoveEvent (stickynotes_plus.py)
