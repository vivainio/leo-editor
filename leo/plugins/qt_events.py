#@+leo-ver=cub-1-thin
#@0 [ekr.20140907103315.18766] @f ../plugins/qt_events.py
...
#@ class LeoQtEventFilter
class LeoQtEventFilter(QtCore.QObject):
    #@+others
    #@>  LeoQtEventFilter.__init__
    ...
    #@ LeoQtEventFilter.eventFilter & helpers
    ...
    #@> LeoQtEventFilter.createKeyEvent
    def createKeyEvent(
    ...
    #@ LeoQtEventFilter.doNonKeyEvent
    ...
    #@ LeoQtEventFilter.shouldIgnoreKeyEvent
    ...
    #@ LeoQtEventFilter.toBinding & helpers
    ...
    def doAltTweaks(self, actual_ch: str, keynum: str, mods: list[str], toString: str) -> list[str]:
        ...
        if (
            kind in ('german', 'spanish')
            and actual_ch in ":;"
            and 'Shift' in mods
            and 'Alt' not in mods
            and 'Control' not in mods
        ):
            mods.remove('Shift')
    ...
    #@<2 LeoQtEventFilter: Tracing
    #@> LeoQtEventFilter.traceKeys
