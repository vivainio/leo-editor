#@+leo-ver=cub-1-thin
#@0 [peckj.20150428142633.1] @f ../plugins/python_terminal.py
#@@language python
#@@tabwidth -4
...
if QtWidgets:
    ...
    class PyInterp(QtWidgets.QTextEdit):
        ...
        #@ PyInterp.updateInterpreterLocals
        ...
        def doEnter(self, event):
            ...
            #@ function: compile_and_run_lines
