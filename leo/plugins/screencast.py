#@+leo-ver=cub-1-thin
#@0 [ekr.20120913110135.10579] @f ../plugins/screencast.py
#@+<< docstring >>
#@> << docstring >>
#@@language rest
...
class ScreenCastController:
    #@+others
    #@> sc.__init__ (ScreenCastController)
    def __init__(self, c):
        self.c = c
        self.commands = []
    ...
    #@ sc.caption and abbreviations: body, log, tree
    ...
    def state_handler(self, event=None):
        ...
        # That way an "extra" escape while dismissing menus will be handled well.
            ...
            m_state_copy = g.bunch(kind=m.k_state.kind, n=m.k_state.n, handler=m.k_state.handler)
            m.single_key(char)
